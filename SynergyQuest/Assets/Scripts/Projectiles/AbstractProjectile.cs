...
{
    [SerializeField] protected int thrust = 1;
    [SerializeField] protected int damageFactor = 1;

    protected readonly int HitTrigger = Animator.StringToHash("Hit");

    protected Vector2 _direction = Vector2.zero;
    protected Animator _animator;
    protected Rigidbody2D _rigidbody2D;
    protected PhysicsEffects _physicsEffects;
     ...
     * </summary>
     */
    public static AbstractProjectile Launch(AbstractProjectile prefab, Vector3 spawnPoint, Vector2 direction)
    {
