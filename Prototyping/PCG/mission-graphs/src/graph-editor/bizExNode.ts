...
import {CustomNode, GGroup, Item, NodeModel} from "gg-editor/lib/common/interfaces";
...
const bizExNode: CustomNode = {
    ...
    setState(name, value, item: Item) {
        ...
        const states = item.getStates() as any[];
