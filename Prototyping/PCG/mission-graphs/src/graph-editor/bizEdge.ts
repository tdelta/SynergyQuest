...
import {CustomEdge, GGroup, GShape} from "gg-editor/lib/common/interfaces";

const ItemState = constants.ItemState;
...
G6.registerEdge('bizEdge', bizFlowEdge as any, 'polyline');
